...
|
*/
$config['CSS_APP_PATH'] = define('CSS_APP_PATH',COM_URL.'application/third_party/css/');
$config['JS_APP_PATH'] = define('JS_APP_PATH',COM_URL.'application/third_party/js/');
$config['WS_URL'] = define('WS_URL',COM_URL.'index.php/ws/json/');
...
$config['BS_JS_PATH'] = define('BS_JS_PATH',COM_URL.'application/third_party/assets/js/');
