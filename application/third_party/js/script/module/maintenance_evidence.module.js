/**
 * @class Tracking.module.maintenance_evidence
 * Module panel for table track_maintenance_evidence
 *
 * @since 29-10-2015 10:12:52
 * @author agung.hp
 */
Tracking.module.maintenance_evidence = Ext.extend(Webi.module.Panel, {
    ...
    initComponent : function() {
        // super
        Tracking.module.maintenance_evidence.superclass.initComponent.call(this);
    },
    buildPanel : function(){
        this.grid = new Tracking.grid.maintenance_evidence({border: false});
        this.initGridEvents();

        return this.grid;
    },
    buildForm : function(){
        this.form = new Tracking.form.maintenance_evidence();
		this.initFormEvents();
...
Ext.reg('module_maintenance_evidence', Tracking.module.maintenance_evidence);