/**
 * @class Tracking.grid.report_maintenance_evidence
 * Grid for table track_maintenance_evidence
 *
 * @author agung.hp
 * @since 29-10-2015 10:12:52
 */
Tracking.grid.report_maintenance_evidence = Ext.extend(Webi.grid.GridPanel, {
    ...
    initComponent : function() {
        ...
        // super
        Tracking.grid.report_maintenance_evidence.superclass.initComponent.call(this);
    },
...
Ext.reg('grid_report_maintenance_evidence', Tracking.grid.report_maintenance_evidence);