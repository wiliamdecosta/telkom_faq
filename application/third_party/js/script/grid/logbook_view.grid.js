/**
 * @class Tracking.grid.logbook_view
 * Grid for table track_application
 *
 * @author agung.hp
 * @since 29-10-2015 10:12:52
 */
Tracking.grid.logbook_view = Ext.extend(Webi.grid.GridPanel, {
    ...
    initComponent : function() {
        ...
        // super
        Tracking.grid.logbook_view.superclass.initComponent.call(this);
    },
...
Ext.reg('grid_logbook_view', Tracking.grid.logbook_view);