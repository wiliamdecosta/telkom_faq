/**
 * @class Tracking.grid.maintenance_detail
 * Grid for table track_maintenance_detail
 *
 * @author agung.hp
 * @since 29-10-2015 10:12:52
 */
Tracking.grid.maintenance_detail = Ext.extend(Webi.grid.GridPanel, {
    ...
    initComponent : function() {
        ...
        // super
        Tracking.grid.maintenance_detail.superclass.initComponent.call(this);
    },
...
Ext.reg('grid_maintenance_detail', Tracking.grid.maintenance_detail);