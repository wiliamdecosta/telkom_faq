...
/**
* Json library
* @class Maintenance_detail_controller
...
class Maintenance_detail_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort', 'str', 'mnt_det_id');
        $dir = getVarClean('dir', 'str', 'DESC');
        $query = getVarClean('query', 'str', '');
        
        $mnt_det_id = getVarClean('mnt_det_id', 'int', 0);
		$mnt_id = getVarClean('mnt_id', 'int', 0);
		$mnt_det_pic = getVarClean('mnt_det_pic', 'str', '');
		$mnt_det_start_date = getVarClean('mnt_det_start_date', 'date', '');
		$mnt_det_due_date = getVarClean('mnt_det_due_date', 'date', '');
		$mnt_det_status = getVarClean('mnt_det_status', 'str', '');
		$mnt_det_created_date = getVarClean('mnt_det_created_date', 'date', '');
		$mnt_det_created_by = getVarClean('mnt_det_created_by', 'str', '');
		$mnt_det_updated_date = getVarClean('mnt_det_updated_date', 'date', '');
		$mnt_det_updated_by = getVarClean('mnt_det_updated_by', 'str', '');
    	...
    	try {
            ...
            $ci = & get_instance();
		    $ci->load->model('maintenance_detail');
		    $table = $ci->maintenance_detail;
...
/* End of file Maintenance_detail_controller.php */
/* Location: ./maintenance_detail/libraries/Maintenance_detail_controller.php */