    ...
    function read() {
    	...
    	try {
            ...
            if(!empty($start_date) && !empty($end_date)) {
                $table->setCriteria("(maintenance.mnt_date between '".$start_date."' and '".$end_date."')");
            }elseif(!empty($start_date)) {
                $table->setCriteria("maintenance.mnt_date = '".$start_date."'");
            }elseif(!empty($end_date)) {
                $table->setCriteria("maintenance.mnt_date = '".$end_date."'");
            }
