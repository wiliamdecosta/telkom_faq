...
class Application_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort', 'str', 'app_id');
        $dir = getVarClean('dir', 'str', 'DESC');
        $query = getVarClean('query', 'str', '');
        
        $app_id = getVarClean('app_id', 'int', 0);
		$app_name = getVarClean('app_name', 'str', '');
		$app_created_date = getVarClean('app_created_date', 'date', '');
		$app_created_by = getVarClean('app_created_by', 'str', '');
		$app_updated_date = getVarClean('app_updated_date', 'date', '');
		$app_updated_by = getVarClean('app_updated_by', 'str', '');
...
/* Location: ./application/libraries/Application_controller.php */