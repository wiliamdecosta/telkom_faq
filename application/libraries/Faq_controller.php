...
class Faq_controller {
    ...
    function read() {
    	...
    	$sort = getVarClean('sort', 'str', 'faq_id');
        $dir = getVarClean('dir', 'str', 'DESC');
        $query = getVarClean('query', 'str', '');
        
        $faq_id = getVarClean('faq_id', 'int', 0);
		$app_id = getVarClean('app_id', 'int', 0);
		$faq_case_name = getVarClean('faq_case_name', 'str', '');
		$faq_case_by = getVarClean('faq_case_by', 'str', '');
		$faq_case_date = getVarClean('faq_case_date', 'date', '');
		$faq_solution = getVarClean('faq_solution', 'str', '');
		$faq_solution_by = getVarClean('faq_solution_by', 'str', '');
		$faq_solution_finish_date = getVarClean('faq_solution_finish_date', 'date', '');
		$faq_description = getVarClean('faq_description', 'str', '');
		$faq_created_date = getVarClean('faq_created_date', 'date', '');
		$faq_created_by = getVarClean('faq_created_by', 'str', '');
...
/* End of file Faq_controller.php */
/* Location: ./faq/libraries/Faq_controller.php */